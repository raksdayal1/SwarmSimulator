...
//
// $Id: state_rk2.h 46 2009-12-08 15:05:36Z underwoodml $
//
/*
----------------
...
class State_rk2 : public State {
  public:
    State_rk2() : State() {}
    State_rk2( double &x, double &xd) : State( x, xd) {}

    void propagate();
    void updateclock();

  protected:
    State_rk2 *factory( double &x, double &xd) {
      return new State_rk2( x, xd);
    }
