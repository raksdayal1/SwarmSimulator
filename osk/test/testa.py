...
dts = [ 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001,
        ...
        1.0 / 300, 1.0 / 400, 1.0 / 600, 1.0 / 450, 1.0 / 700, 1.0 / 800, 1.0 / 900]
...
if TEST == 5: #passed 12-06-04
  whrandom.seed( 238)
  tmax = 1000000.0
  ff = 100000

if TEST == 6: #passed 12-06-04
  N = 20
  whrandom.seed( 138)
  tmax = 1000000.0
  ff = 10000

if TEST == 7: #passed 12-06-04
  dts = [ 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001,
          0.2, 0.02, 0.002, 0.0002, 0.00002, 0.000002,
          0.3, 0.03, 0.003, 0.0003, 0.00003, 0.000003]
